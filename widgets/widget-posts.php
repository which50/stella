...
if ( ! class_exists( 'Vw_widget_posts' ) ) {
	...
	class Vw_widget_posts extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$vw_secondary_query = new WP_Query( apply_filters( 'vw_filter_widget_posts_query', $query_args, $args['widget_id'] ) );
		...
		function form( $instance ) {
			...
			<p>
				...
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id('style') ); ?>" name="<?php echo esc_attr( $this->get_field_name('style') ); ?>">
					...
					<option value="small-1-col-1" <?php selected( $style, 'small-1-col-1' ); ?>>Small Thumbnail 1</option>

					<option value="mix-1-col-1" <?php selected( $style, 'mix-1-col-1' ); ?>>Mix 1</option>

					<option value="mix-2-col-1" <?php selected( $style, 'mix-2-col-1' ); ?>>Mix 2</option>

					<option value="custom-1" <?php selected( $style, 'custom-1' ); ?>>Custom 1</option>

					<option value="custom-2" <?php selected( $style, 'custom-2' ); ?>>Custom 2</option>

					<option value="custom-3" <?php selected( $style, 'custom-3' ); ?>>Custom 3</option>

					<option value="custom-4" <?php selected( $style, 'custom-4' ); ?>>Custom 4</option>
