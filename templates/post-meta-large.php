	...
	<div class="vw-post-meta-inner">
		...
		<span class="vw-post-author" <?php vw_itemprop('author'); vw_itemtype('Person'); ?>>
			...
			<?php if ( ! vw_has_coauthors() ) : ?>
				...
				<a class="author-name" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'View all posts by %s', 'envirra' ), get_the_author() ) ); ?>" rel="author" <?php vw_itemprop('name'); ?>><?php the_author(); ?></a>
