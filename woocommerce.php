			...
			<div class="vw-page-content" role="main" itemprop="mainContentOfPage">
				<?php if ( is_product_category() ) : ?>
					<div class="vw-page-title-box clearfix">
						...
						<div class="vw-page-title-box-inner">
							<div class="vw-page-title-box-inner">
								<span class="vw-label vw-alternate-font"><?php _e( 'Products in', 'envirra' ); ?></span>
								<h1 class="vw-page-title"><?php echo esc_html( single_cat_title( '', false ) ); ?></h1>

								<?php if ( category_description() ) : ?>
								<div class="vw-page-description"><?php echo esc_html( category_description() ); ?></div>
								<?php endif; ?>
							</div>
				...
				<?php elseif ( is_product_tag() ) : ?>
					<div class="vw-page-title-box clearfix">
						...
						<div class="vw-page-title-box-inner">
							<span class="vw-label vw-alternate-font"><?php _e( 'Products Tagged', 'envirra' ); ?></span>

							<h1 class="vw-page-title"><?php echo esc_html( single_tag_title( '', false ) ); ?></h1>
						</div>
					</div>
				...
				<?php elseif ( ! is_product() && '0' !== get_post_meta( vw_get_shop_page_id(), 'vw_show_page_title', true ) ) : ?>
					<div class="vw-page-title-box clearfix">
						...
						<div class="vw-page-title-box-inner">
							<h1 class="vw-page-title"><?php echo esc_html( $shop_name ); ?></h1>
							<?php if ( $subtitle ) : ?>
