	...
	static function admin_page(){
		...
		<div class="wrap">
			...
			<p>
				...
				You can create how many sidebars you want and then go and <a href="<?php admin_url( 'post-new.php?post_type=page' ); ?>">Create</a> or <a href="<?php admin_url( 'edit.php?post_type=page' ); ?>">Edit</a> a page and asign this custom sidebar. You can assign it even to a post or anything else just go to a page, post or theme options and find the otion to select a sidebar.<strong>The shortcode is provided optional in case if you need it. Is not necesary to use it.</strong><br />
				The sidebar will be added automaticaly to <a href="<?php admin_url( 'widgets.php' ); ?>">Widgets</a> page
			</p>
			<br />
