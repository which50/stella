...
if ( ! defined( 'VW_THEME_VERSION' ) ) define( 'VW_THEME_VERSION', '1.1.0' );

if ( ! defined( 'VW_THEME_NAME' ) ) define( 'VW_THEME_NAME', 'WHICH50' );
...
if ( ! function_exists( 'vw_get_archive_blog_layout' ) ) {
	...
	function vw_get_archive_blog_layout() {
		...
		if ( is_category() ) {
			...
			$blog_layout = 'large-1-col-2';

		}



		return apply_filters( 'vw_filter_get_archive_blog_layout', $blog_layout );
...
if ( ! function_exists( 'vw_setup_secondary_query' ) ) {

	function vw_setup_secondary_query() {
...
if ( ! function_exists( 'vw_reset_secondary_query' ) ) {

	function vw_reset_secondary_query() {

		global $vw_secondary_query;

		$vw_secondary_query = null;
