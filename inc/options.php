...
if ( ! function_exists( 'vw_get_theme_option' ) ) {
	function vw_get_theme_option( $opt_name, $default = null ) {
		global $vw_stella;
		if ( isset( $vw_stella[ $opt_name ] ) ) return $vw_stella[ $opt_name ];
		else return $default;
	}
}
 ...
 * -------------------------------------------------------------------------- */
$theme = wp_get_theme();
$vw_opt_name = 'vw_stella';

$help_html = '<a href="http://envirra.com/themes/stella/document/" target="_blank"><img src="'.get_template_directory_uri().'/images/admin/help-documentation.png"></a>';
$help_html .= '<a href="http://envirra.com/themes/stella/document/#troubleshooting" target="_blank"><img src="'.get_template_directory_uri().'/images/admin/help-troubleshooting.png"></a>';
	...
	'fields'     => array(
	   array(
		...
		array(
			...
			'output'	=> array( '.vw-site-header__inner' ),
			'units'	=> 'px',
			'top'	=> true,
			'right'	=> false,
			'bottom'=> true,
...
Redux::setSection( $vw_opt_name, array(
	...
	'fields'     => array(
		array(
			...
			'options' => array(
				'small-1-col-1' => 'Small Thumbnail 1  (1 Column)',
				...
				'large-1-col-2' => 'Large 1',
				'large-2-col-1' => 'Large 2',
				'mix-1-col-2' => 'Mix 1',
				'mix-2-col-2' => 'Mix 2',
				'custom-1' => 'Custom 1',
				'custom-2' => 'Custom 2',
...
Redux::setSection( $vw_opt_name, array(
	...
	'fields'     => array(
		...
		array(
			...
			'output'        => array( '.vw-menu-location-main' ), // An array of CSS selectors to apply this font style to dynamically
			// 'compiler'      => array('h2.site-description-compiler'), // An array of CSS selectors to apply this font style to dynamically
			'units'         => 'px', // Defaults to px
			'subtitle'      => 'Choose font for main menu text.',
			'default'       => array(
				'font-weight'    => '600',
...
Redux::setSection( $vw_opt_name, array(
	...
	'fields'     => array(
	  array(
			...
			'mode' => 'background',
			'transparent'=> false,
			'output' => array( '.vw-top-bar__inner' ),
			'default' => '#000000'
		),
	),
) );
	...
	'fields'     => array(
	  array(
		...
		array(
			...
			'mode' => 'background',
			'transparent'=> false,
			'output' => array( '.vw-menu-location-top .sub-menu' ),
			'default' => '#ffffff'
		),
		array(
