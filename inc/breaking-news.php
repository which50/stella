...
if ( ! function_exists( 'vw_query_get_breaking_news_posts' ) ) {
	function vw_query_get_breaking_news_posts() {
		$query_args = array(
			'post_type' => 'post',
		...
		*/
		...
		return new WP_Query( apply_filters( 'vw_filter_breaking_news_query_args', $query_args ) );
	}
}